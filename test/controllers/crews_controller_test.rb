...
class CrewsControllerTest < ActionController::TestCase
  ...
  test "should create crew" do
    assert_difference('Crew.count') do
      post :create, crew: { doubleBook?: @crew.doubleBook?, foreman: @crew.foreman, notes: @crew.notes, size: @crew.size }
    end
  ...
  test "should update crew" do
    patch :update, id: @crew, crew: { doubleBook?: @crew.doubleBook?, foreman: @crew.foreman, notes: @crew.notes, size: @crew.size }
    assert_redirected_to crew_path(assigns(:crew))
  end
